...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/1.png)

那么如何在一个函数去拟合这些点? 即找到一个函数来尽可能对应输入输出. 线性回归当然可以获得一条直线:

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/2.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/3.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/4.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/5.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/6.png)

以上是常见的模型演示图

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/7.png)

那么还要提及结构化数据和非结构化数据. 结构化数据很好用database去容纳, 但是一短音频, 一张图片可能这种数据结构就非常难以处理. 但是深度学习让计算机开始理解非结构化数据了

### 为什么最近机器学习火起来了?

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/8.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/9.png)

第一部分的安排

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/10.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/11.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/12.png)

那么Y也要有对应的整个的输出矩阵, 我们横过来排放: 

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/13.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/14.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/15.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/16.png)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/17.png)

上面绿色推导可以看出来: 这个函数很符合我们的预期! 为什么这个函数非常好? 这个我们之后会讲

Finally, 损失函数反映了在**单个**训练样本上的表现; 那么我再定义一个成本函数, 用来衡量在全体训练样本上的表现

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/18.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/19.png)

不难看出, J将会是一个二元函数, 那么在三维坐标系中是一个曲面:

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/20.png)

我们定义的函数很好的做到了凸函数这一点, 避免了多个局部最优解的问题(选择了那个Loss Function定义的原因正是这个)

那么我们随便初始化一个点, 然后试图在不断迭代中往下面走, 直到走到最低点, 那么最终走到的集中的点就是最优解了

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/21.png)

我们先只看w轴, 我们重复操作, 操作如上图: 注意到alpha就是学习率, 然后这个学习率乘以的是当前点的导数

自己想想下, 就会发现这个是合理的; 当然, 在编程的时候, notational convention是用**"dw"**来代表当前点的导数(蓝字)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/22.png)

在程序中, w和b通过这样的形式不断进行更迭; 在微积分中, 我们更喜欢用偏导符号; 在编程中, 就是db  dw

### 计算

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/23.png)

上面的计算反应了一个点(假设特征nx=2)所对应的更迭. 这个计算我是能推的, 就是流程图与偏导计算; 但是现实是有m个训练样本:

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/24.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/25.png)

所以在logistic regression里面, 我们也可以使用这种艺术:

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/26.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/27.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/28.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/29.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/30.png)

上面这个模型中, 有输入层, 隐藏层和输出层, 中间的节点的值我们是看不见的

表示输入层还可以用图中的a[0], 上标, a代表activation

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/31.png)

注意a[1]在Python中的四维表达形式, 四维是因为这里面只有四个节点; **注意, 输入层不算层, 第一个隐藏层是第一层, 这个图是两层**

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/32.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/33.png)

注意到第一个隐藏层的每一个节点的流程都在上方标出, 那么四个节点都能表达出来: 

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/34.png)

看得出来, 四个节点的计算可以同时进行, 那么我们就可以考虑使用向量化了. 向量化的式子推导如上图

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/35.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/36.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/37.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/38.png)

这个函数的斜率: 当z是正的话, 斜率就是1; 如果是负数, 就是0; 注意到如果z是0, 这个地方的倒数是没有定义的

但是在编程中, 其实z值完全是0的概率非常非常低; 注意到如果z是负数的话, 斜率就是0, 这在实践中没有意义, 所以有"泄露ReLU"

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/39.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/40.png)

梯度下降过程: 先随机设置w[1] b[1] (注意, 随机初始化是十分重要的), 然后算出所有的预测y值, 通过这些东西计算dw db, 然后更新w, b作为[2]的材料

### 反向传播

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/41.png)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/42.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/43.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/44.png)

附: 有些函数只有深层的神经网络才能学习, 而对于一开始来说, 尝试Logistics regression总是不会错的

接下来完善一下notational convention

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/45.png)

### Forward and Backward Propagation

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/46.png)

前向传播很好理解, 输入了a[l-1], 然后用随机初始化的W和b去计算l层的z  a

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/47.png)

反向传播, 就是用da[l]来算出da[l-1] (用于继续反向传播), dw, db(用来修正w和b矩阵)

(注意上图左边第二行的a[l-1]还应该要转置)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/48.png)

注意, 头一个da[l]在logistic regression下就是损失熵函数的倒数

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/49.png)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/50.png)

上图帮忙算出了w和b矩阵的维数, 还有dw  db的维数, 还有Z A dZ  dA 的维数, 这帮助了我们debug

### 搭建神经网络块

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/51.png)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/52.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/53.png)

### 参数&超参数(Hyperparameter)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/54.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/55.png)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/56.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/57.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/58.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/59.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/60.png)

换个角度去理解：在激活函数中，假如说z很靠近0，那么这一段就越接近线性；如果惩罚了，z下降了，那么落在的激活函数的区间段可能其影响效果更偏向于线性。这样的话，模型就不会过度复杂

### Dropout正则化

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/61.png)

每一次的训练，随机丢掉一定的节点，其连线都删除，避免单一依赖于一个特征的情况出现

那么如何实现dropout呢

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/62.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/63.png)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/64.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/65.png)

### 梯度消失/爆炸&随机初始化参数

Data Vanishing/Exploding Gradients 

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/66.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/67.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/68.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/69.png)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/70.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/71.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/72.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/73.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/74.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/75.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/76.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/77.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/78.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/79.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/80.png)

先是momentum的质数加权平均，后来是RMSprop, **并且还进行了bias correction**

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/81.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/82.png)

为什么要学习率衰减？直觉上来看，一开始希望轨迹步伐迈的大一点，但是之后当到达了最低点附近，我们不希望步伐依然那么大了，不然就会在最低点附近反复摆动

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/83.png)

一种常见的衰减方法如上图：decay_rate又是一个超参数，epoch代表训练“轮”数，上面这个式子中，如果epoch很大，说明已经走了很多次了，我们希望学习率下降，那么这个式子正好表示了这种关系

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/84.png)

当然还有其他的衰减方法，但是核心思路都是epoch上升后，learning rate要下降（还有手动调参的。）

### 局部最优问题（local optima）

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/85.png)
...
3. hidden layers; learning rate decay
 ...
 ![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/86.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/87.png)

假设考虑的学习率从0.0001到1，那么再均匀取值貌似有点不可取；可以通过对数转换，然后指数区间中堆随机取数字，这样就更合理一些

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/88.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/89.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/90.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/91.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/92.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/93.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/94.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/95.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/96.png)

假如说C代表我想分的类的数量（这里是4，除了三种动物，还有0，代表不是三种动物之一），因此我希望神经网络输出层输出的yhat是一个（4，1）的向量，输出的四个数字分别代表四种可能性（当然，四个数字和应该是1）

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/97.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/98.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/99.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/100.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/101.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/102.png)

同时注意到，如果从左到右是灰色变成白色的话，之后的结果中间就是黑色的。这是我们想要见到的结果！不然的话怎么知道这个边界从左到右是从灰到白还是从白到灰！

当然上面的都是检测竖直方向垂直的过滤器，水平的也很好猜到：

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/103.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/104.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/105.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/106.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/107.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/108.png)

上面这个案例很好的展示了三位filter究竟是怎么操作的。注意，filter一定？×？×3，因为要涵盖三个通道

当然，如果我只想检测红色通道的边缘，那么两层是0，红色那一层是检测边缘的filter就可以了

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/109.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/110.png)

filter相当于w，人为加上的bias相当于b, 对处理完后的图片（类似于z）用非线性激活函数处理（上图中例子为ReLU），最后得到了一个图片（相当于a(i)[l]），最后堆叠起来（相当于a[l]），一切都串联起来了！

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/111.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/112.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/113.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/114.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/115.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/116.png)

有了CONV  POOL  FC三张牌，那么怎么打就是一个需要探索的问题。如何有效安排卷积层池化层和全连接层从而形成高效的模型一直以来是CV中的研究热门

### 为何卷积如此高效？

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/117.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/118.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/119.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/120.png)

AlexNet : 这个网络模型更夸张了，有60000000个参数需要学习；另外，这个模型正式使用了ReLU函数，并且开创性地在两个GPU上面跑这个模型；这个模型还用了LRN（Local Response Normalization）但很少用了

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/121.png)

VGG-16 ：这里面先CONV，再same pooling，之后再max pooling, 有16层；尺寸的下降和通道数的增加呈一定规律；这个模型更加庞大，有1.38亿的参数需要学习。

### ResNet

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/122.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/123.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/124.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/125.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/126.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/127.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/128.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/129.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/130.png)

发现这样一来，计算量变成了1240万，差不多变成了十分之一

那么有了这样的思想，来看下inception网络的结构：

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/131.png)

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/132.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/133.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/134.png)

第一类常见的手段就是对这个图片的“图形”进行改变，例如镜像对称，随即截图，或者旋转、sheering等等

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/135.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/136.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/137.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/138.png)
...
### Object Detection
 ...
 ![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/139.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/140.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/141.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/142.png)

YOLO的亮点在于：一个物体可能横跨很多格子，但是人工标注之后，取这个框的中心点，然后认为点所落在的网格的向量中的第一个参数是1。在grid更加精细的情况下，两个物体的中心点在一个框内的概率就非常小了

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/143.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/144.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/145.png)

那么在落实“认为中心点只落在一个格子”地时候，现实是周围很多格子都可能会想我这里有个车，因此我的pc参数很接近于1，因此我也应该给出我自己这个格子预测的框的位置。为了避免复杂情况，直接取pc最大的值的框，而放弃其他的框。

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/146.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/147.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/148.png)

当然如果出现了两个框真的都和一个anchor box高度相似，那么这种情况就很难处理了

### YOLO正式介绍

![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/149.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/dl_study_screenshot/150.png)
