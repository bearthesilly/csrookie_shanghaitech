...
![image](https://github.com/bearthesilly/csrookie/blob/main/C%2B%2B%E7%AC%94%E8%AE%B0/png/2.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/C%2B%2B%E7%AC%94%E8%AE%B0/png/1.png)
...
![image](https://github.com/bearthesilly/csrookie/blob/main/C%2B%2B%E7%AC%94%E8%AE%B0/png/3.png)
...
Breadcrumbs[CS100-slides-spring2024](https://github.com/GKxxQAQ/CS100-slides-spring2024/tree/master)/[l7](https://github.com/GKxxQAQ/CS100-slides-spring2024/tree/master/l7)
...
[![GKxxQAQ](https://avatars.githubusercontent.com/u/72719139?v=4&size=40)](https://github.com/GKxxQAQ)[GKxxQAQ](https://github.com/GKxxQAQ/CS100-slides-spring2024/commits?author=GKxxQAQ)



[update l7](https://github.com/GKxxQAQ/CS100-slides-spring2024/commit/0c9a3efabeecedc3b9fa6bb69f0cfef8f6aac62f)

[0c9a3ef](https://github.com/GKxxQAQ/CS100-slides-spring2024/commit/0c9a3efabeecedc3b9fa6bb69f0cfef8f6aac62f) · last week

## History

[History](https://github.com/GKxxQAQ/CS100-slides-spring2024/commits/master/l7/l7.md)

814 lines (542 loc) · 20.4 KB
...
[Raw](https://github.com/GKxxQAQ/CS100-slides-spring2024/raw/master/l7/l7.md)





| marp | math    | paginate | style                                                        |
| ---- | ------- | -------- | ------------------------------------------------------------ |
| true | mathjax | true     | section::after { content: attr(data-marpit-pagination) '/' attr(data-marpit-pagination-total); } |
...
- Typically, the memory allocation function
  ...
  - Memory does not have types. - We say "a disk of 1TB" instead of "a disk that can hold 238 `int`s".
...
[![img](https://github.com/GKxxQAQ/CS100-slides-spring2024/raw/master/l7/img/stack_vs_heap.jpg)](https://github.com/GKxxQAQ/CS100-slides-spring2024/blob/master/l7/img/stack_vs_heap.jpg)
...
[![img](https://github.com/GKxxQAQ/CS100-slides-spring2024/raw/master/l7/img/malloc2d.png)](https://github.com/GKxxQAQ/CS100-slides-spring2024/blob/master/l7/img/malloc2d.png)
...
- They may allocate
  ...
  memory, for some reasons. In that case, the address of the allocated memory is returned.
...
`calloc`: Allocates `num * each_size` bytes of memory 2, each byte initialized to zero, and returns its starting address.
